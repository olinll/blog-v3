...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ri:qq-line', text: '交流群: 1105154206', url: 'https://qm.qq.com/q/jfltzwYmas' },
		...
		nav: [
			...
			// },
			{
				title: '社交',
				items: [
					{ icon: 'tabler:brand-github', text: 'Github', url: 'https://github.com/olinll' },
					{ icon: 'ri:qq-line', text: 'QQ', url: 'https://qm.qq.com/q/jfltzwYmas' },
