...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ri:qq-line', text: '交流群: 1105154206', url: 'https://qm.qq.com/q/kIYB1Q8MP6' },
		...
		nav: [
			...
			},
			{
				...
				items: [
					...
					{ icon: 'ri:qq-line', text: '群: 1105154206', url: 'https://qm.qq.com/q/kIYB1Q8MP6' },
			...
			},
			{
				...
				items: [
					...
					{ icon: 'tabler:world-www', text: '苏ICP备2022020192号-1', url: 'https://beian.miit.gov.cn/' },
					{ icon: 'tabler:shield-check', text: '苏公网安备32021302003009号', url: 'https://beian.mps.gov.cn/web/beian/32021302003009/' },
				],
			},
		] satisfies Nav,
	},
	...
	nav: [
		{
			...
			items: [
				...
				{ icon: 'tabler:pencil', text: '编辑器', url: '/editor' },
			],
		},
	] satisfies Nav,
