...
image: https://oss.olinl.com/cover/basic-auth-auto-login-bypass.webp
categories: [网络]
...
::pic
---
src: https://oss.olinl.com/basic-auth-auto-login-bypass/20260627091109_dx09.webp
caption: Basic Auth鉴权方式实例
---
::
...
::pic
---
src: https://oss.olinl.com/basic-auth-auto-login-bypass/20260627091054_88fo.webp
caption: 验证是否为Basic Auth
---
::
...
格式如下：  
:copy{prompt code="http://<用户名>:<密码>@<ip地址或域名>:<端口号，如果是80可以不填>"}
:copy{prompt code="https://<用户名>:<密码>@<ip地址或域名>:<端口号，如果是443可以不填>"}

例如：  
`http://admin:password@10.1.13.80:9100`


::alert{type="warning" card title="使用FRP会报一个错误"}
