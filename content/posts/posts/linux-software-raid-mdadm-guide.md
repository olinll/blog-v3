...
::alert{type="tip" title="小规模 HomeLab 优先选 RAID 1"}
...
::alert{type="tip" title="GPT 上的 \"primary\" 是什么"}
...
::alert{type="tip" title="fstab 最后两列的含义"}
...
::alert{type="tip" title="邮件 + HTTP 建议同时配"}
