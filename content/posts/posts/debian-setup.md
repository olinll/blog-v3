...
::alert{type="info" title="> 建议根据你的设备架构，选择`iso-dvd`完整安装镜像。"}
...
::alert{type="warning" title="> 如果你的网络中有 DHCP 服务器，系统自动配置了，可以点击返回按钮，选择返回，然后按照下面教程继续即可"}
