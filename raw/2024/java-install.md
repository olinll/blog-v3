...
> 使通过下载 tar.gz 包手动安装 JDK 1.8，配置 JAVA_HOME 等环境变量，适用于 CentOS、Debian、Ubuntu 等主流发行版。
...
JDK 8 在2026年还在大量生产环境跑着（Spring Boot 2.x、Hadoop、老项目一堆）<br />
